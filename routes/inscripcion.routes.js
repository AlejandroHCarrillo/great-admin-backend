 ...
 */
 ...
 const { getInscriptions, getInscriptionById, 
         createInscription, createInscriptions, 
         deleteInscription, updateInscription, 
         findInscriptions, getInscriptionsReport } = require('../controllers/inscripcion.controller');
 ...
 router.get('/report/:ciclo', getInscriptionsReport );
